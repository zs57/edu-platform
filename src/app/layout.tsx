...
export const metadata: Metadata = {
  title: "منصة الباير (EL-BIO) | إمبراطورية الكيمياء والفيزياء في جيبك",
  description: "منصة تعليمية أونلاين، شرح كيمياء ثانوية عامة، مراجعة فيزياء لغات وعربي. أفضل مدرس كيمياء ثانوية عامة. إحنا مش مجرد منصة بتشرح دروس، إحنا سيستم متكامل مبني على ذكاء الوقت.",
